          ...
          <div className="flex flex-col lg:flex-row gap-12">
                ...
                <div className="bg-white p-8 rounded-xl shadow-md">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <button
                      ...
                      className={`w-full px-6 py-3 bg-indigo-600 text-white font-medium rounded-xl hover:bg-indigo-700 transition-colors ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                    >
            ...
            <div className="lg:w-1/3">
              <div className="bg-indigo-50 p-8 rounded-xl">
                <h3 className="text-xl font-bold mb-6 text-indigo-800">Contact Information</h3>
